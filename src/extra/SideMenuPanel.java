...
public class SideMenuPanel {
    ...
    public void closeMenu() {
        if (getIsOpen()) {
            ...
            side.setSize(new Dimension(newWidth, side.getHeight()));
            main.setLocation(newWidth, main.getY());
            setGLSize(newWidth);

            for (Component child : ((Container) side).getComponents()) {
                if (child instanceof JButton) {
                    JButton button = (JButton) child;
                    button.setSize(new Dimension(newWidth, button.getHeight()));
                }
            }
    ...
    public void openMenu() {
        if (!getIsOpen()) {
            int newWidth = minWidth + maxWidth;
            side.setSize(new Dimension(newWidth, side.getHeight()));
            main.setLocation(newWidth, main.getY());
            setGLSize(newWidth);
            x = maxWidth;
